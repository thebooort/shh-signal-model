...
fig, ax = plt.subplots()
ax.plot(t, evol_ptc, label=r'Ptc Lai-Saha' )
ax.plot(t, evol_ptc_1, label=r'Ptc New Model' )
...
ax.hlines(y=evol_ptc[-1], xmin=0, xmax=len(evol_ptc)/10, linewidth=1.5 ,color='blue', linestyles='dotted', label=str(evol_ptc[-1]))
ax.legend(loc='best', fancybox=True, framealpha=0.5)
plt.show()

fig, ax = plt.subplots()
ax.plot(t, evol_gli3, label=r'Gli3 Lai-Saha' )
ax.plot(t, evol_gli3_1, label=r'Gli3 New Model' )
...
ax.hlines(y=evol_gli3[-1], xmin=0, xmax=len(evol_gli3)/10, linewidth=1.5 ,color='blue', linestyles='dotted', label=str(evol_gli3[-1]))
ax.legend(loc='best', fancybox=True, framealpha=0.5)
plt.show()

fig, ax = plt.subplots()
ax.plot(t, evol_gli3r, label=r'Gli3R Lai-Saha' )
ax.plot(t, evol_gli3r_1, label=r'Gli3R New Model' )
...
ax.hlines(y=evol_gli3r[-1], xmin=0, xmax=len(evol_gli3r)/10, linewidth=1.5 ,color='blue', linestyles='dotted', label=str(evol_gli3r[-1]))
ax.legend(loc='best', fancybox=True, framealpha=0.5)
plt.show()